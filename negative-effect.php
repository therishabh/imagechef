...
<div class="row">
	<div class="col-lg-3 col-centered">
		<div class="heading">Negative Effect</div>
	</div>
</div>
 <div class="work-div">
 	<div class="row">
 		<div class="col-lg-9 col-centered">
 			<div class="row">
 				...
 				<div class="col-lg-2">
 					<form action="negative-convert.php" method="post">
 				...
 				<div class="col-lg-5">
 					<div class="upload-image">
 						...
 						if(isset($_SESSION['image_name']) && !empty($_SESSION['image_name']))
 						{
 							echo '<img src="effect/negative/'.$_SESSION['image_name'].'" alt="">';
 						}
 						else
 						{
 			...
 			<div class="row" style="margin-top:20px;">
 				...
 				<div class="col-lg-5 col-lg-offset-2">
					...
					if(isset($_SESSION['image_name']) && !empty($_SESSION['image_name']))
					{
						echo '<a href="effect/negative/'.$_SESSION['image_name'].'"><div class="submit-btn">Save</div></a>';
					}
